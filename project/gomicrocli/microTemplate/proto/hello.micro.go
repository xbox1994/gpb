...
func (c *helloService) Hello(ctx context.Context, in *go_api.Request, opts ...client.CallOption) (*go_api.Response, error) {
...
func (h *helloHandler) Hello(ctx context.Context, in *go_api.Request, out *go_api.Response) error {
